  ...
  return (
    <div className="Footer">
      ...
      <div className="email elementFooter">
        ...
        <a href="mailto:BELOTnicolas@hotmail.fr" className="link">
          <p>BELOTnicolas@hotmail.fr</p>
        </a>
      </div>
      ...
      <div className="linkedin elementFooter">
        ...
        <a
          href="https://www.linkedin.com/in/nicolas-belot-749a52226/"
          className="link"
        >
          Linkedin
        </a>
      ...
      <div className="git elementFooter">
        ...
        <a
          href="https://github.com/Belot-Nicolas?tab=repositories"
          className="link"
        >
          GitHub
        </a>
